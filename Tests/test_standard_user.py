...
class TestHome:
    ...
    def test_login_into_swaglabs(self, driver: WebDriver):
        """
        This test checks if user can successfully log into
        :param driver:WebDriver instance of Selenium WebDriver
        """
        ...
        login_button.click()
        driver.implicitly_wait(3)
        assert driver.current_url == XpathsSauceDemo.inventory_url
        driver.find_element_by_xpath(XpathsSauceDemo.inventory_container)
